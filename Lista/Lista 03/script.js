...
document.write(`<p><b>Texto original: </b>${textoOriginal}</p>`)
document.write(`<p><b>Total (palavras analisadas): </b>${texto.length}</p>`)

document.write(`<p><b>Frases:</b></p>`)

frases=textoOriginal
...
document.write("</ul>");
document.write(`<p><b>Total de frases: </b>${frases.length-1}</p>`)
